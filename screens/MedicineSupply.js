...
const MedicineSupply = ({ navigation }) => {
      ...
      {showDeleted ? (
        deletedMedicines.map((medicine, index) => {
          const daysUsed = Math.floor(
            (new Date(medicine.deletionDate) - new Date(medicine.creationDate)) /
            (24 * 60 * 60 * 1000)
          );
            ...
            >
              ...
              <View style={styles.medicineDaysContainer}>
                <Text style={styles.medicineDaysLeft}>
                  Gebruikt voor {daysUsed} dagen
                </Text>
                <View>
                  <Text style={styles.medicineCreationDate}>
                    {new Date(medicine.creationDate).toLocaleDateString('nl-NL')} t/m {new Date(medicine.deletionDate).toLocaleDateString('nl-NL')}
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
